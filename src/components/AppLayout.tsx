...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-full flex flex-col">
      <header className="sticky top-0 z-20 bg-white/80 dark:bg-slate-950/80 backdrop-blur ring-1 ring-slate-200 dark:ring-slate-800">
      ...
      <main className="flex-1 mx-auto w-full max-w-3xl px-4 py-6 pb-[max(env(safe-area-inset-bottom),1.5rem)]">
        {children}
      </main>
    </div>
  );
